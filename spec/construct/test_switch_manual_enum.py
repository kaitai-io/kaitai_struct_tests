...
import unittest
from switch_manual_enum import _schema
...
class TestSwitchManualEnum(unittest.TestCase):
    def test_switch_manual_enum(self):
        ...
        self.assertEqual(r.opcodes[0].code, 'strval')
        self.assertEqual(r.opcodes[0].body.value, u"foobar")
        self.assertEqual(r.opcodes[1].code, 'intval')
        self.assertEqual(r.opcodes[1].body.value, 66)
        self.assertEqual(r.opcodes[2].code, 'intval')
        self.assertEqual(r.opcodes[2].body.value, 55)
        self.assertEqual(r.opcodes[3].code, 'strval')
