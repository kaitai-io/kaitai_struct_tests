...
BOOST_AUTO_TEST_CASE(test_switch_manual_int_size) {
    ...
    BOOST_CHECK(r->chunks()->at(2)->_is_null_body()); // added manually
    BOOST_CHECK_EQUAL(r->chunks()->at(2)->body(), nullptr); // added manually
    BOOST_CHECK_EQUAL(r->chunks()->at(3)->code(), 255);
    BOOST_CHECK_EQUAL(r->chunks()->at(3)->_raw_body(), std::string("", 0));
    BOOST_CHECK(r->chunks()->at(3)->_is_null_body()); // added manually
    BOOST_CHECK_EQUAL(r->chunks()->at(3)->body(), nullptr); // added manually
