...
class RepeatUntilCalcArrayTypeTest extends TestCase {
    public function testRepeatUntilCalcArrayType() {
        $r = RepeatUntilCalcArrayType::fromFile(self::SRC_DIR_PATH . '/repeat_until_process.bin');
