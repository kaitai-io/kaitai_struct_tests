...
class StrEncodingsDefaultTest extends TestCase {
    public function testStrEncodingsDefault() {
        ...
        $this->assertEquals("\u{3053}\u{3093}\u{306b}\u{3061}\u{306f}", $r->rest()->str2());
        $this->assertEquals("\u{3053}\u{3093}\u{306b}\u{3061}\u{306f}", $r->rest()->str3());
        $this->assertEquals("\u{2591}\u{2592}\u{2593}", $r->rest()->str4());
    }
}
