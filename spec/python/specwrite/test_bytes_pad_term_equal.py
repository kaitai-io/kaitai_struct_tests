...
class TestBytesPadTermEqual(CommonSpec.Base):
    ...
    def test_check_longer_s1(self):
        ...
        with self.assertRaisesRegexp(ConsistencyError, u"^Check failed: s1,"):
            r._check()
    ...
    def test_check_longer_s2(self):
        ...
        with self.assertRaisesRegexp(ConsistencyError, u"^Check failed: s2,"):
            r._check()
    ...
    def test_check_longer_s3(self):
        ...
        with self.assertRaisesRegexp(ConsistencyError, u"^Check failed: s3,"):
            r._check()
    ...
    def test_check_longer_s4(self):
        ...
        with self.assertRaisesRegexp(ConsistencyError, u"^Check failed: s4,"):
            r._check()
