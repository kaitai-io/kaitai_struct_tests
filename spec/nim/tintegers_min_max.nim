...
assert r.signedMin.s4le == -2147483648'i64
assert r.signedMin.s8le == -9223372036854775808'u64
assert r.signedMin.s2be == -32768
assert r.signedMin.s4be == -2147483648'i64
assert r.signedMin.s8be == -9223372036854775808'u64
