...
assert (SwitchManualIntSizeElse_Chunk_ChunkMeta(r.chunks[0].body)).title == string("Stuff")
assert (SwitchManualIntSizeElse_Chunk_ChunkMeta(r.chunks[0].body)).author == string("Me")
