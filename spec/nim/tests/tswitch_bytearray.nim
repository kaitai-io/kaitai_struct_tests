...
test "SwitchBytearray":
  ...
  check(r.opcodes[0].code == string(@[83].mapIt(it.toByte).toString))
  check(r.opcodes[0].body.value == string("foobar"))
  check(r.opcodes[1].code == string(@[73].mapIt(it.toByte).toString))
  check(r.opcodes[1].body.value == uint8(66))
  check(r.opcodes[2].code == string(@[73].mapIt(it.toByte).toString))
  check(r.opcodes[2].body.value == uint8(55))
  check(r.opcodes[3].code == string(@[83].mapIt(it.toByte).toString))
