...
testHelper('DebugEnumName', 'src/fixed_struct.bin', function(r) {
    ...
    assert.equal(r.testType._debug.field1.enumName, "DebugEnumName.TestSubtype.InnerEnum1");
    assert.equal(r.testType._debug._m_instanceField, undefined);
    r.testType.instanceField;
    assert.equal(r.testType._debug._m_instanceField.enumName, "DebugEnumName.TestSubtype.InnerEnum2");
});
