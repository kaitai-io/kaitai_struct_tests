...
RSpec.describe 'DefaultEndianExprIsBe' do
  it 'parses test properly' do
    ...
    expect(r.docs[0].main.inst_int).to eq 66
    expect(r.docs[0].main.inst_sub.foo).to eq 66
    ...
    expect(r.docs[1].main.inst_int).to eq 1107296256
    expect(r.docs[1].main.inst_sub.foo).to eq 1107296256
    expect(r.docs[2].indicator).to eq [88, 88].pack('C*')
    expect(r.docs[2].main.some_int).to eq 1107296256
    expect(r.docs[2].main.some_int_be).to eq 66
    expect(r.docs[2].main.some_int_le).to eq 66
    expect(r.docs[2].main.inst_int).to eq 66
    expect(r.docs[2].main.inst_sub.foo).to eq 66
  end
end
