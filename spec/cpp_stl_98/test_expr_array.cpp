...
BOOST_AUTO_TEST_CASE(test_expr_array) {
    ...
    BOOST_CHECK_CLOSE(r->afloat_first(), -2.6839530254859364E-121, 100 * (1e-6) / (-2.6839530254859364E-121));
    BOOST_CHECK_CLOSE(r->afloat_last(), -1.1103359815095273E-175, 100 * (1e-6) / (-1.1103359815095273E-175));
    BOOST_CHECK_CLOSE(r->afloat_min(), -8.754689149998834E+288, 100 * (1e-6) / (-8.754689149998834E+288));
    BOOST_CHECK_CLOSE(r->afloat_max(), -1.1103359815095273E-175, 100 * (1e-6) / (-1.1103359815095273E-175));
