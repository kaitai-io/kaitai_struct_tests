...
const _imp_enum_of_value_inst = @import("../formats/enum_of_value_inst.zig");
...
test "EnumOfValueInst" {
    ...
    try _imp_std.testing.expectEqual(_imp_enum_of_value_inst.EnumOfValueInst.Animal.dog, (try r.pet4()));
}
