...
const repeat_until_bytes_pad = @import("../formats/repeat_until_bytes_pad.zig");
...
test "RepeatUntilBytesPad" {
    ...
    const r = try repeat_until_bytes_pad.RepeatUntilBytesPad.create(&arena, &_io, null, null);
