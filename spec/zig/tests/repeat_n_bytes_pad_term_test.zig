...
const repeat_n_bytes_pad_term = @import("../formats/repeat_n_bytes_pad_term.zig");
...
test "RepeatNBytesPadTerm" {
    ...
    const r = try repeat_n_bytes_pad_term.RepeatNBytesPadTerm.create(&arena, &_io, null, null);
