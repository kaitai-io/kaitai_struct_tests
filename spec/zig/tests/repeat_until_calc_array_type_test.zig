...
const repeat_until_calc_array_type = @import("../formats/repeat_until_calc_array_type.zig");
...
test "RepeatUntilCalcArrayType" {
    ...
    const r = try repeat_until_calc_array_type.RepeatUntilCalcArrayType.create(&arena, &_io, null, null);
