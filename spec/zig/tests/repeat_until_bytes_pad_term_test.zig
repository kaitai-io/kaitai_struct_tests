...
const repeat_until_bytes_pad_term = @import("../formats/repeat_until_bytes_pad_term.zig");
...
test "RepeatUntilBytesPadTerm" {
    ...
    const r = try repeat_until_bytes_pad_term.RepeatUntilBytesPadTerm.create(&arena, &_io, null, null);
