...
use kaitai_test_suite::instance_std_array::InstanceStdArray;

#[test]
fn test_instance_std_array() {
    let r = InstanceStdArray::from_file("../../src/instance_std_array.bin").expect("file for parsing is not found");
