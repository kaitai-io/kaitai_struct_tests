...
use kaitai_test_suite::switch_manual_int_size_else::SwitchManualIntSizeElse;

#[test]
fn test_switch_manual_int_size_else() {
    let r = SwitchManualIntSizeElse::from_file("../../src/switch_tlv.bin").expect("file for parsing is not found");
