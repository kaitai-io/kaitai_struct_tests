...
use kaitai_test_suite::index_to_param_until::IndexToParamUntil;

#[test]
fn test_index_to_param_until() {
    let r = IndexToParamUntil::from_file("../../src/index_sizes.bin").expect("file for parsing is not found");
