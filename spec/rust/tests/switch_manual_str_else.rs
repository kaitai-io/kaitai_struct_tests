...
use kaitai_test_suite::switch_manual_str_else::SwitchManualStrElse;

#[test]
fn test_switch_manual_str_else() {
    let r = SwitchManualStrElse::from_file("../../src/switch_opcodes2.bin").expect("file for parsing is not found");
