...
use kaitai_test_suite::default_endian_expr_inherited::DefaultEndianExprInherited;

#[test]
fn test_default_endian_expr_inherited() {
    let r = DefaultEndianExprInherited::from_file("../../src/endian_expr.bin").expect("file for parsing is not found");
