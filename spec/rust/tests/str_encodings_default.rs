...
use kaitai_test_suite::str_encodings_default::StrEncodingsDefault;

#[test]
fn test_str_encodings_default() {
    let r = StrEncodingsDefault::from_file("../../src/str_encodings.bin").expect("file for parsing is not found");
