...
use kaitai_test_suite::default_endian_expr_is_be::DefaultEndianExprIsBe;

#[test]
fn test_default_endian_expr_is_be() {
    let r = DefaultEndianExprIsBe::from_file("../../src/endian_expr.bin").expect("file for parsing is not found");
