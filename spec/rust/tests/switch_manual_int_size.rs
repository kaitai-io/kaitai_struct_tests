...
use kaitai_test_suite::switch_manual_int_size::SwitchManualIntSize;

#[test]
fn test_switch_manual_int_size() {
    let r = SwitchManualIntSize::from_file("../../src/switch_tlv.bin").expect("file for parsing is not found");
