...
use kaitai_test_suite::type_ternary_2nd_falsy::TypeTernary2ndFalsy;

#[test]
fn test_type_ternary_2nd_falsy() {
    let r = TypeTernary2ndFalsy::from_file("../../src/switch_integers.bin").expect("file for parsing is not found");
