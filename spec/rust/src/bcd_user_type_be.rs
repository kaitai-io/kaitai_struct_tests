...
impl KaitaiStruct for BcdUserTypeBe {
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        self.ltr = new bcd_user_type_be::ltr_obj($io, $this, _root);
        self._raw_rtl = stream->readBytes(4);
        $io = new &mut S(self._raw_rtl);
        self.rtl = new bcd_user_type_be::rtl_obj($io, $this, _root);
        self._raw_leadingZeroLtr = stream->readBytes(4);
        $io = new &mut S(self._raw_leadingZeroLtr);
        self.leadingZeroLtr = new bcd_user_type_be::leading_zero_ltr_obj($io, $this, _root);
    ...
    public function digit2() {
        if (self.digit2 !== null)
            return self.digit2;
        self.digit2 = ($this->b1() & 15);
        return self.digit2;
    }
    public function digit4() {
        if (self.digit4 !== null)
            return self.digit4;
        self.digit4 = ($this->b2() & 15);
        return self.digit4;
    }
    public function digit3() {
        if (self.digit3 !== null)
            return self.digit3;
        self.digit3 = (($this->b2() & 240) >> 4);
        return self.digit3;
    }
    public function digit5() {
        if (self.digit5 !== null)
            return self.digit5;
        self.digit5 = (($this->b3() & 240) >> 4);
        return self.digit5;
    }
    public function digit8() {
        if (self.digit8 !== null)
            return self.digit8;
        self.digit8 = ($this->b4() & 15);
        return self.digit8;
    }
    public function digit6() {
        if (self.digit6 !== null)
            return self.digit6;
        self.digit6 = ($this->b3() & 15);
        return self.digit6;
    }
    ...
    public function digit1() {
        if (self.digit1 !== null)
            return self.digit1;
        self.digit1 = (($this->b1() & 240) >> 4);
        return self.digit1;
    }
    public function digit7() {
        if (self.digit7 !== null)
            return self.digit7;
        self.digit7 = (($this->b4() & 240) >> 4);
        return self.digit7;
    }
}
        };
