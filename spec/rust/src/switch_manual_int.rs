...
impl KaitaiStruct for SwitchManualInt {
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        $i = 0;
        while (!stream->isEof()) {
            self.opcodes[] = new switch_manual_int::opcode(stream, $this, _root);
            $i++;
        }
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        switch ($this->code()) {
            case 73:
                self.body = new switch_manual_int::opcode::intval(stream, $this, _root);
                break;
            case 83:
                self.body = new switch_manual_int::opcode::strval(stream, $this, _root);
                break;
        }
