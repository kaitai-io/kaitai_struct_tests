...
impl KaitaiStruct for SwitchManualStr {
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        $i = 0;
        while (!stream->isEof()) {
            self.opcodes[] = new switch_manual_str::opcode(stream, $this, _root);
            $i++;
        }
    ...
    fn read<S: KaitaiStream>(&mut self,
        ...
        switch ($this->code()) {
            case "I":
                self.body = new switch_manual_str::opcode::intval(stream, $this, _root);
                break;
            case "S":
                self.body = new switch_manual_str::opcode::strval(stream, $this, _root);
                break;
        }
