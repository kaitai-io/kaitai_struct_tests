...
function TestExprCalcArrayOps:test_expr_array()
    ...
    luaunit.assertAlmostEquals(r.double_array_first, 10.0, prec)
    luaunit.assertAlmostEquals(r.double_array_mid, 25.0, prec)
    luaunit.assertAlmostEquals(r.double_array_last, 3.14159, prec)
    luaunit.assertAlmostEquals(r.double_array_min, 3.14159, prec)
    luaunit.assertAlmostEquals(r.double_array_max, 100.0, prec)
