...
require("test_valid_long")
require("test_valid_not_parsed_if")
require("test_valid_short")
require("test_valid_switch")
require("test_yaml_ints")
require("test_zlib_with_header_78")
