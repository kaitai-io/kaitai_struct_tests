...
srequire("test_combine_bool")
srequire("test_combine_bytes")
srequire("test_combine_enum")
...
srequire("test_expr_bytes_literal")
...
srequire("test_integers")
srequire("test_integers_min_max")
...
srequire("test_nested_type_param")
...
srequire("test_params_pass_array_int")
srequire("test_params_pass_array_str")
srequire("test_params_pass_array_struct")
srequire("test_params_pass_array_usertype")
...
srequire("test_valid_long")
srequire("test_valid_not_parsed_if")
srequire("test_valid_short")
srequire("test_valid_switch")
srequire("test_yaml_ints")
srequire("test_zlib_surrounded")
srequire("test_zlib_with_header_78")
