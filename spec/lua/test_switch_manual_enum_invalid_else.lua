...
function TestSwitchManualEnumInvalidElse:test_switch_manual_enum_invalid_else()
    ...
    luaunit.assertEquals(r.opcodes[1].code, 255)
    luaunit.assertEquals(r.opcodes[1].body.value, 123)
    luaunit.assertEquals(r.opcodes[2].code, 1)
    luaunit.assertEquals(r.opcodes[2].body.value, 123)
end
