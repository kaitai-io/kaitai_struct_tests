...
class CSharpBuilder < PartialBuilder
  ...
  def detect_runner
    candidates = [
      ENV['HOME'] + "/.nuget/packages/nunit.consolerunner/3.17.0/tools/nunit3-console.exe",
      "spec/csharp/packages/NUnit.ConsoleRunner.3.17.0/tools/nunit3-console.exe",
    ]
    ...
    raise "Unable to find NUnit.ConsoleRunner.3.17.0 exe file anywhere, tried: #{candidates.inspect}"
  end
